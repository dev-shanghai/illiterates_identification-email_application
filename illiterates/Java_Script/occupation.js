...
divMid.style.backgroundColor = '#ff72ff';
...
divMid.style.backgroundColor = '#ff72ff';
// Now Inside Divs
/*framePics = document.getElementById("framePics"); 
framePics.style.height = (screenHeight * (0.7)) + 'px';
framePics.style.width = (screenWidth * (0.8)) + 'px';
framePics.style.backgroundColor = '#ff72ff';
*/
