...
document.getElementById("womenDivA").style.marginLeft = (viewPortWidth * (0.05)) + 'px';
document.getElementById("womenDivB").style.marginLeft = (viewPortWidth * (0.1)) + 'px';
...
document.getElementById("womenDivA").style.height = (viewPortHeight * (0.2)) + 'px';
document.getElementById("womenDivA").style.width = (viewPortWidth * (0.20)) + 'px';

document.getElementById("womenDivB").style.height = (viewPortHeight * (0.2)) + 'px';
document.getElementById("womenDivB").style.width = (viewPortWidth * (0.20)) + 'px';
